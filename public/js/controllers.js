 ...
 *
 */
function MainCtrl($rootScope, AuthTokenFactory, $location) {

	//alert('called');
	var guestUser = false;/*{
		SSN        : "3502357951",
		birthday   : "1955-08-05",
		created_at : "2015-08-03 14:30:19",
		department : "maintenance",
		email      : "Maiya.Boehm@yahoo.com",
		first_name : "Guest",
		hourly_rate: "11.61",
		id         : 22,
		job_title  : null,
		last_name  : "ObjVisitor",
		phone      : "1-929-105-9687x156",
		phone2     : "219-800-1988",
		start_date : "1997-10-15",
		updated_at : "2015-08-03 14:30:19",
		verified   : 0
	};*/
$rootScope.logout = function () {
	...
	$rootScope.currentUser = $rootScope.currentUser || guestUser;
	$rootScope.$watch('currentUser', function(newVal, oldVal, scope){
		console.log('change in $rootScope.currentUser has been detected!');
	});

		$rootScope.$on('login', function(event, args){
			console.log ('EVENT: $on(login)');console.log ( event ); //marker
			$rootScope.currentUser = args.user;
			$rootScope.GLOBAL_STATUS_STATE = { isLoggedOut:false, isLoggedIn:true };
			console.log ('args');console.log ( args ); //marker
		});
		$rootScope.$on('logout', function(event){
			console.log ('EVENT: $on(logout)');
			$rootScope.GLOBAL_STATUS_STATE = { isLoggedOut:true, isLoggedIn:false };
			$rootScope.currentUser = false;
